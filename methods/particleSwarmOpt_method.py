# python file for pso method

##### TEMPORARY PASTED ALL CODE HERE BEFORE MOVING IT TO A SEPARATE PACKAGE #####
import math
import random
...
def op_perm_fix(x, R):
    ...
    :param R: the precedence constraints: R = {(i,j) | i must precede j in permutation}.
...
class DPSO:
    def __init__(self, pop_size, coef_inertia, coef_personal, coef_social):
